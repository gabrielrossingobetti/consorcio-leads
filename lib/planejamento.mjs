 ...
 *   valor: number, orcamento: string, momento: string, lance: string,
...
export function validarPlanejamento(input) {
  ...
  return { ok: true, data: {
    ...
    lance: body.lance, consentimento: true, ciente_contemplacao: true, atribuicao,
  } };
}
...
export function notasPlanejamento(data) {
  return JSON.stringify({
    ...
    momento: data.momento, lance: data.lance,
