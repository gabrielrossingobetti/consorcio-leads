  ...
  return (
    <main className="lidera-site">
      <article className="lp-container lp-privacy">
        ...
        <p>O formulário coleta nome, WhatsApp, tipo de bem, crédito desejado, faixa de orçamento mensal, momento de compra e intenção de atendimento. Também registra suas confirmações sobre o pedido de contato e a ciência das condições de contemplação, junto com a data do pedido.</p>
        <h2>Para que usamos essas informações</h2>
        <p>Para responder ao seu pedido, entender seu objetivo e orientar a conversa sobre consórcio. O envio não contrata um produto e não implica aprovação de crédito nem contemplação. Após salvar o pedido, a página encaminha você ao WhatsApp com uma mensagem que inclui seu objetivo e as respostas sobre seu momento; você revisa e envia essa mensagem. As informações também podem ajudar a avaliar a qualidade do atendimento e das campanhas que originam os pedidos.</p>
