...
function DirecionamentoContent() {
  ...
  // Volta ao simulador já com o contexto do lead e abre o agendamento direto
  const agendarUrl =
    `/?agendar=1&produto=${encodeURIComponent(produto)}&credito=${credito}` +
              ...
              <div className="relative z-10">
                ...
                <div className="px-6 pt-8 pb-16" style={{ maxWidth: 'min(54%, 640px)' }}>
                  ...
                  <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }}
                    ...
                    {/* Reunião é a ação principal — converte 12x mais que conversa solta no WhatsApp */}
                    <a href={agendarUrl}
                    ...
                    <a href={whatsappUrl} target="_blank" rel="noopener noreferrer"
                      className="flex items-center justify-center gap-2 py-3 px-6 rounded-2xl font-semibold text-sm transition-all active:scale-[0.98]"
